package com.yxsh.uibase.roundview;
...
/**
 * RoundImageView已废弃，采用google原生的ShapeableImageView
 */
@Deprecated
public class RoundImageView extends AppCompatImageView {
    ...
    private final int DEFAULT_BORDER_COLOR = Color.TRANSPARENT;
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            mLeftTopCornerRadius = a.getDimensionPixelSize(
                    R.styleable.RoundedImageView_rv_left_top_corner_radius, 0);
            mRightTopCornerRadius = a.getDimensionPixelSize(
                    R.styleable.RoundedImageView_rv_right_top_corner_radius, 0);
            mLeftBottomCornerRadius = a.getDimensionPixelSize(
                    R.styleable.RoundedImageView_rv_left_bottom_corner_radius, 0);
            mRightBottomCornerRadius = a.getDimensionPixelSize(
                    R.styleable.RoundedImageView_rv_right_bottom_corner_radius, 0);
            ...
            mBorderWidth = a.getDimensionPixelSize(
                    R.styleable.RoundedImageView_rv_border_width, 0);
            if (mBorderWidth < 0) {
                throw new IllegalArgumentException("border width cannot be negative.");
            }

            mBorderColor = a
                    .getColorStateList(R.styleable.RoundedImageView_rv_border_color);
            if (mBorderColor == null) {
                mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
            }

            isOval = a.getBoolean(R.styleable.RoundedImageView_rv_oval, false);
            a.recycle();
    ...
    public void updateLeftTopCornerRadius(float leftTopCornerRadius) {
        this.mLeftTopCornerRadius = leftTopCornerRadius;
        configRadii();
        invalidate();
    }

    public void updateRightTopCornerRadius(float rightTopCornerRadius) {
        this.mRightTopCornerRadius = rightTopCornerRadius;
        configRadii();
        invalidate();
    }

    public void updateLeftBottomCornerRadius(float leftBottomCornerRadius) {
        this.mLeftBottomCornerRadius = leftBottomCornerRadius;
        configRadii();
        invalidate();
    }

    public void updateRightBottomCornerRadius(float rightBottomCornerRadius) {
        this.mRightBottomCornerRadius = rightBottomCornerRadius;
        configRadii();
        invalidate();
    }

    public void updateTopCornerRadius(float topCornerRadius) {
        this.mLeftTopCornerRadius = topCornerRadius;
        this.mRightTopCornerRadius = topCornerRadius;
        configRadii();
        invalidate();
    }

    public void updateBottomCornerRadius(float bottomCornerRadius) {
        this.mLeftBottomCornerRadius = bottomCornerRadius;
        this.mRightBottomCornerRadius = bottomCornerRadius;
        configRadii();
        invalidate();
    }
    ...
    public void updateBorderColor(int color) {
