package com.yxsh.uibase.uicore.utils;
...
public class FragmentStarter {
    ...
    public static BaseFragment pushFragmentToBackStack(FragmentActivity activity, @IdRes int containerId, Class<? extends BaseFragment> cls, Object data, boolean isAddStatck) {
    ...
    public static void popTopFragment(FragmentActivity activity, Class<? extends BaseFragment> cls) {
        FragmentManager fm = activity.getSupportFragmentManager();
    ...
    public static void goToFragment(FragmentActivity activity, Class<? extends BaseFragment> cls) {
